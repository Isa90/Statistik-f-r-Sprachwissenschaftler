...
for(s in c(3,4,5) ){
  ...
  output <- paste("Bei einer Standabweichung von",s, "bestehen",ausgezeichnet*100,"% sehr gut.")
  print(output)
}
```
...
3. Wie viele Studenten bekommen weniger als 10 NP?
    ...
    `r (pnorm(9,mean=mu,sd=3) - pnorm(0,mean=mu,sd=3) ) * n` Studenten bekommen weniger als 10 Notenpunkte.

4. Wie viele Studenten bekommen weniger als 8 NP?

    `r (pnorm(7,mean=mu,sd=3) - pnorm(0,mean=mu,sd=3) ) * n` Studenten bekommen weniger als 8 Notenpunkte.
...
Der kritische Wert für einen einseitigen $z$-Test ist `z_{1-\alpha}`.
...
Das ist ein **r_insignifikanter_** Unterschied. 
