...
for (s in c(3, 4, 5)) {
    ...
    output <- paste("Bei einer Standabweichung von", s, "bestehen", durchfall * 
        100, "% sehr gut.")
    print(output)
}
```
...
```
## [1] "Bei einer Standabweichung von 3 bestehen 27.4253117750074 % sehr gut."
## [1] "Bei einer Standabweichung von 4 bestehen 27.4253117750074 % sehr gut."
## [1] "Bei einer Standabweichung von 5 bestehen 27.4253117750074 % sehr gut."
```


Wie steht die Anzahl guter Noten in Beziehung zur Anzahl schlechter Noten? 

Die Anzahl der guten Noten ist gleichmäßig verteilt, dies ist bei den schlechten Noten nicht der Fall.

Warum?

Es gibt 3 Möglichkeiten, eine ausgezeichnete Note zu bekommen (13, 14 und 15 Punkte). Für das Durchfallen gibt es allerdings mehr Möglichkeiten(4, 3, 2, 1, 0 Punkte).
...
2. Wie viele Studenten bekommen zumindest 10 NP?
    ...
    12.1339 Studenten bekommen zumindest 10 Notenpunkte.

3. Wie viele Studenten bekommen weniger als 10 NP?

    31.3364 Studenten bekommen weniger als 10 Notenpunkte.

4. Wie viele Studenten bekommen weniger als 8 NP?

    18.2805 Studenten bekommen weniger als 8 Notenpunkte.
...
Die kritischen Werte für einen zweiseitigen $z$-Test sind 
